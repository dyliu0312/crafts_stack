...
#SBATCH --output=log_halofit_numerical_jk%j.log
...
export OUTPUT="/work/home/liudy/data/stack_result/galaxy_pair_stack/halofit_jk/crafts_df122k_xsize3000_nfs10_mean_numerical_result.h5"
...
python -u /work/home/liudy/mycode/stack/halofit_numerical_jk.py
echo "------------------------fished--------------------------"
...
export OUTPUT="/work/home/liudy/data/stack_result/galaxy_pair_stack/halofit_jk/tng_df120k_pcaloss_xsize3000_nfs10_mean_numerical_result.h5"
